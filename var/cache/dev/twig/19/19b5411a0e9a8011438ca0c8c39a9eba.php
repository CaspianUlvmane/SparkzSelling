...
<button data-controller=\"scrollevents\" data-action=\"click->scrollevents#scrollevent\" class=\"text-lg rounded-full bg-Blue-200 w-fit m-auto p-4 pl-7 pr-7 font-semibold hover:bg-white transition-all duration-300\" href=\"/#contact\">Boka möte</button>
